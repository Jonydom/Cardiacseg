...
from networks import CNNBackbone
from networks.DeTrans.DeformableTrans import DeformableTransformer
from networks.DeTrans.position_encoding import build_position_encoding
    ...
    def posi_mask(self, x):
        ...
        for lvl, fea in enumerate(x):
            if lvl > 1:
                ...
                masks.append(torch.zeros((fea.shape[0], fea.shape[2], fea.shape[3], fea.shape[4]), dtype=torch.bool, device=fea.device))
